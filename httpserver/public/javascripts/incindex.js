...
function searchwords(){var wd=jQuery.trim($('#searchwrods').val()).replace(/\./g,''); if(''==wd || '客官要点什么'==wd){$('#searchwrods').attr('placeholder','客官还没点呢');return;}querywords(wd);}
